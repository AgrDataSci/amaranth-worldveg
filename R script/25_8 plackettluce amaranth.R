...
for(i in seq_along(d_i)){
  ...
  # put in the matrix
  R[[i]] <- rank_tricot(d_i[[i]], items = 1:3, input = 4:5)
...
worth_map(mod, labels = names(mod)) 
###
## How do I make network plot? 
##
a <- adjacency(R[[1]])
...
png(filename = "output/worthmap_amaranth_mali_no_three_even.png", width = 30, height = 45, units = "cm", res = 400)
worth_map(mod, labels = names(mod))  
dev.off()

# reference existed
png(filename = "output/worthmap_amaranth_mali_no_three_even_reference_is_local_mali.png", width = 30, height = 45, units = "cm", res = 400)
worth_map(mod, labels = names(mod), ref = "Local Mali") 
dev.off()

##
# save worth  plots as png file 
png(filename = paste0("output/", names(mod)[1], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[1]])
dev.off()

png(filename = paste0("output/", names(mod)[2], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[2]])
dev.off()

png(filename = paste0("output/", names(mod)[3], "_mali_worth_plot.png"), width = 30, height = 30, units = "cm", res = 400)
plot_worth(mod[[3]]) 
dev.off()

png(filename = paste0("output/", names(mod)[4], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[4]])
dev.off()

png(filename = paste0("output/", names(mod)[5], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[5]])
dev.off()

png(filename = paste0("output/", names(mod)[6], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[6]]) 
dev.off()

png(filename = paste0("output/", names(mod)[7], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[7]]) 
dev.off()

png(filename = paste0("output/", names(mod)[8], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[8]]) 
dev.off()

png(filename = paste0("output/", names(mod)[9], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[9]]) 
dev.off()

png(filename = paste0("output/", names(mod)[10], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[10]]) 
dev.off()

png(filename = paste0("output/", names(mod)[11], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[11]]) 
dev.off()

png(filename = paste0("output/", names(mod)[12], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[12]]) 
dev.off()

png(filename = paste0("output/", names(mod)[13], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[13]]) 
dev.off()

png(filename = paste0("output/", names(mod)[14], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[14]]) 
dev.off()

png(filename = paste0("output/", names(mod)[15], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[15]]) 
dev.off()

png(filename = paste0("output/", names(mod)[16], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[16]]) 
dev.off()

png(filename = paste0("output/", names(mod)[17], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[17]]) 
dev.off()

png(filename = paste0("output/", names(mod)[18], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[18]]) 
dev.off()

png(filename = paste0("output/", names(mod)[19], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[19]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[20], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[20]]) 
dev.off()

png(filename = paste0("output/", names(mod)[21], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[21]]) 
dev.off()

png(filename = paste0("output/", names(mod)[22], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[22]]) 
dev.off()

png(filename = paste0("output/", names(mod)[23], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[23]]) 
dev.off()

png(filename = paste0("output/", names(mod)[24], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[24]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[25], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[25]]) 
dev.off()

png(filename = paste0("output/", names(mod)[26], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[26]]) 
dev.off()

png(filename = paste0("output/", names(mod)[27], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[27]]) 
dev.off()

png(filename = paste0("output/", names(mod)[28], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[28]]) 
dev.off()

png(filename = paste0("output/", names(mod)[29], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[29]]) 
dev.off()

png(filename = paste0("output/", names(mod)[30], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[30]]) 
dev.off()

png(filename = paste0("output/", names(mod)[31], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[31]]) 
dev.off()

png(filename = paste0("output/", names(mod)[32], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[32]]) 
dev.off()

png(filename = paste0("output/", names(mod)[33], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[33]]) 
dev.off()

png(filename = paste0("output/", names(mod)[34], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[34]]) 
dev.off()

png(filename = paste0("output/", names(mod)[35], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[35]]) 
dev.off()

png(filename = paste0("output/", names(mod)[36], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[36]]) 
dev.off()

png(filename = paste0("output/", names(mod)[37], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[37]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[38], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[38]]) 
dev.off()

png(filename = paste0("output/", names(mod)[39], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[39]]) 
dev.off()

png(filename = paste0("output/", names(mod)[40], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[40]]) 
dev.off()

png(filename = paste0("output/", names(mod)[41], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[41]]) 
dev.off()

png(filename = paste0("output/", names(mod)[42], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[42]]) 
dev.off()

png(filename = paste0("output/", names(mod)[43], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[43]]) 
dev.off()

png(filename = paste0("output/", names(mod)[44], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[44]]) 
dev.off()

png(filename = paste0("output/", names(mod)[45], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[45]])
dev.off()

png(filename = paste0("output/", names(mod)[46], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[46]]) 
dev.off()

png(filename = paste0("output/", names(mod)[47], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[47]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[48], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[48]]) 
dev.off()

png(filename = paste0("output/", names(mod)[49], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[49]]) 
dev.off()

png(filename = paste0("output/", names(mod)[50], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[50]]) 
dev.off()

png(filename = paste0("output/", names(mod)[51], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[51]]) 
dev.off()

png(filename = paste0("output/", names(mod)[52], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[52]]) 
dev.off()

png(filename = paste0("output/", names(mod)[53], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[53]]) 
dev.off()

png(filename = paste0("output/", names(mod)[54], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[54]]) 
dev.off()

png(filename = paste0("output/", names(mod)[55], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[55]]) 
dev.off()

png(filename = paste0("output/", names(mod)[56], "_mali_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[56]]) 
dev.off()



# save summary as txt files 
for (i in seq_along(mod)) {
capture.output(summary(mod[[i]], ref = "Local Mali"), 
               print(paste0(names(mod[i]), "_PL_summary")),
               coef(mod[[i]], ref = "Local Mali"),
               file =paste0("output/",names(mod[i]), "_PL_summary.txt"))}
...
### recacluate ranking for kendall taue
# list of ground nut ranking
 R_for_k <- vector(mode = "list", length = length(mali_traits_list))
 
 for (i in seq_along(mali_traits_list)) {
   
   R_for_k[[i]] <-rank_tricot(data = mali_df, 
                        items = variety,
                        input =c(unlist(mali_traits_list[i])),
                        validation.rankings = FALSE)}  # do not cosider evencase.
 
 
 mod_for_k = lapply(R_for_k, PlackettLuce)

## summary does not work.... because all even case   
summary(mod_for_k[[1]])
#  
#  # remove emty vectors in the list
# 
#  
#  # Identify empty vectors
# empty_indices <- lapply(mod_for_k, function(vec) length(unique(vec$coefficients)) == 1)
# 
#  # Remove empty vectors
# mod_for_k<- mod_for_k[!unlist(empty_indices)]
# length(mod_for_k)


#Calculate triats' kendell tau correlations ship
#Prepare the correlation matrix to be filled with values
length(mod_for_k)  #length(mod_for_k)
r <- matrix(NA, nrow=length(mod_for_k), ncol=length(mod_for_k))

#Prepare the effective N matrix
p_value <- matrix(NA, nrow=length(mod_for_k), ncol=length(mod_for_k))

for(i in 1:length(mod_for_k)){
  for (j in 1:length(mod_for_k)){ #Fills lower triangle only, to avoid calculating the same value twice
    
    rNij <- kendallTau(R_for_k[[i]], R_for_k[[j]], null.rm = TRUE, na.omit =TRUE) 
...
#### this codes are for summary. 
# Prepare list of rankings for different traits
# I may ignore A = B = C cases
d_i<- list()

for(i in 1:length(benin_traits_list)){
  d_i_t <- cbind(benin_df[, c("package_item_A", "package_item_B", "package_item_C")], benin_df[, benin_traits_list[[i]]])
  d_i_t <- d_i_t[-which(is.na(d_i_t[,4]) & is.na(d_i_t[,5])),]
  d_i[[i]]  <- d_i_t
}

names(d_i) <- names(benin_traits_list)
...
# remove d_i[[14]] because only one farmer respond 
d_i<- d_i[-(14)]
...
##
# save worth map plots as png file 
png(filename = "output/worthmap_amaranth_benin_no_three_even.png", width = 30, height = 45, units = "cm", res = 400)
worth_map(mod, labels = names(mod))  
dev.off()

# reference existed
png(filename = "output/worthmap_amaranth_benin_no_three_even_reference_is_local_benin.png", width = 30, height = 45, units = "cm", res = 400)
worth_map(mod, labels = names(mod), ref = "Local Benin") 
dev.off()
...
plot_worth(mod[[31]])  + scale_x_continuous(limits=c(0,0.3))
dev.off()
...
# save summary as txt files 
for (i in seq_along(mod)) {
  capture.output(summary(mod[[i]], ref = "Local Benin"), 
                 print(paste0(names(mod[i]), "Benin_PL_summary")),
                 coef(mod[[i]], ref = "Local Benin"),
                 file =paste0("output/",names(mod[i]), "Benin_PL_summary.txt"))}
...
### recacluate ranking for kendall taue
# list of ground nut ranking
R_for_k <- vector(mode = "list", length = length(benin_traits_list))

for (i in seq_along(benin_traits_list)) {
  
  R_for_k[[i]] <-rank_tricot(data = benin_df, 
                             items = variety,
...
for(i in 1:length(tanzania_traits_list)){
  d_i_t <- cbind(tanzania_df[, c("package_item_A", "package_item_B", "package_item_C")], tanzania_df[, tanzania_traits_list[[i]]])
  d_i_t <- d_i_t[-which(is.na(d_i_t[,4]) & is.na(d_i_t[,5])),]
  d_i[[i]]  <- d_i_t
}

names(d_i) <- names(tanzania_traits_list)
...
png(filename = "output/worthmap_amaranth_tanzania_no_even_reference_is_Local_check_(AC-NL).png", width = 30, height = 45, units = "cm", res = 400)
worth_map(mod, labels = names(mod), ref ="Local check (AC-NL)") 
dev.off()
...
plot_worth(mod[[25]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()
...
# save summary as txt files 
for (i in seq_along(mod)) {
  capture.output(summary(mod[[i]], ref = "Local check (AC-NL)"), 
                 print(paste0(names(mod[i]), "tanzania_PL_summary")),
                 coef(mod[[i]], ref = "Local check (AC-NL)"),
                 file =paste0("output/",names(mod[i]), "tanzania_PL_summary.txt"))}
...
### recacluate ranking for kendall taue
# list of ground nut ranking
R_for_k <- vector(mode = "list", length = length(tanzania_traits_list))

for (i in seq_along(tanzania_traits_list)) {
  
  R_for_k[[i]] <-rank_tricot(data = tanzania_df, 
                             items = variety,
...
three_countries_traits_list <- list()
for (i in seq_along(trait_neg)){
  three_countries_traits_list[[i]] <- c(trait_neg[i], trait_pos[i])}

# allocate trait name into trait list
splittedname<- strsplit(trait_neg, "_")

for (i in seq_along(splittedname)){
  names(three_countries_traits_list)[[i]]<- paste0(splittedname[[i]][1],"_", splittedname[[i]][2])}
...
for(i in 1:length(three_countries_traits_list)){
  d_i_t <- cbind(three_df_excluded[, c("package_item_A", "package_item_B", "package_item_C")], three_df_excluded[, three_countries_traits_list[[i]]])
  d_i_t <- d_i_t[-which(is.na(d_i_t[,4]) & is.na(d_i_t[,5])),]
  d_i[[i]]  <- d_i_t
}
names(d_i) <- names(three_countries_traits_list)
...
worth_map(mod, labels = names(mod), ref ="Poli") 
dev.off()
...
##
# save worth  plots as png file 
png(filename = paste0("output/", names(mod)[1], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[1]])
dev.off()

png(filename = paste0("output/", names(mod)[2], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[2]]) 
dev.off()

png(filename = paste0("output/", names(mod)[3], "_three_conturies_worth_plot.png"), width = 30, height = 30, units = "cm", res = 400)
plot_worth(mod[[3]]) 
dev.off()

png(filename = paste0("output/", names(mod)[4], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[4]])
dev.off()

png(filename = paste0("output/", names(mod)[5], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[5]])
dev.off()

png(filename = paste0("output/", names(mod)[6], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[6]]) 
dev.off()

png(filename = paste0("output/", names(mod)[7], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[7]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[8], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[8]]) 
dev.off()

png(filename = paste0("output/", names(mod)[9], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[9]]) 
dev.off()

png(filename = paste0("output/", names(mod)[10], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[10]]) 
dev.off()

png(filename = paste0("output/", names(mod)[11], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[11]]) 
dev.off()

png(filename = paste0("output/", names(mod)[12], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[12]]) 
dev.off()

png(filename = paste0("output/", names(mod)[13], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[13]]) 
dev.off()

png(filename = paste0("output/", names(mod)[14], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[14]]) 
dev.off()

png(filename = paste0("output/", names(mod)[15], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[15]]) 
dev.off()

png(filename = paste0("output/", names(mod)[16], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[16]]) 
dev.off()

png(filename = paste0("output/", names(mod)[17], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[17]])
dev.off()

png(filename = paste0("output/", names(mod)[18], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[18]]) 
dev.off()

png(filename = paste0("output/", names(mod)[19], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[19]]) 
dev.off()

png(filename = paste0("output/", names(mod)[20], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[20]]) 
dev.off()

png(filename = paste0("output/", names(mod)[21], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[21]]) 
dev.off()

png(filename = paste0("output/", names(mod)[22], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[22]]) 
dev.off()

png(filename = paste0("output/", names(mod)[23], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[23]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[24], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[24]]) 
dev.off()

png(filename = paste0("output/", names(mod)[25], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[25]]) 
dev.off()

png(filename = paste0("output/", names(mod)[26], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[26]]) 
dev.off()

png(filename = paste0("output/", names(mod)[27], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[27]]) 
dev.off()

png(filename = paste0("output/", names(mod)[28], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[28]]) 
dev.off()

png(filename = paste0("output/", names(mod)[29], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[29]]) 
dev.off()

png(filename = paste0("output/", names(mod)[30], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[30]]) 
dev.off()

png(filename = paste0("output/", names(mod)[31], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[31]]) 
dev.off()

png(filename = paste0("output/", names(mod)[32], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[32]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[33], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[33]]) 
dev.off()

png(filename = paste0("output/", names(mod)[34], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[34]]) 
dev.off()

png(filename = paste0("output/", names(mod)[35], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[35]]) 
dev.off()

png(filename = paste0("output/", names(mod)[36], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[36]]) 
dev.off()

png(filename = paste0("output/", names(mod)[37], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[37]]) 
dev.off()

png(filename = paste0("output/", names(mod)[38], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[38]]) 
dev.off()

png(filename = paste0("output/", names(mod)[39], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[39]]) 
dev.off()

png(filename = paste0("output/", names(mod)[40], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[40]]) 
dev.off()

png(filename = paste0("output/", names(mod)[41], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[41]]) 
dev.off()

png(filename = paste0("output/", names(mod)[42], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[42]]) 
dev.off()

png(filename = paste0("output/", names(mod)[43], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[43]]) 
dev.off()

png(filename = paste0("output/", names(mod)[44], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[44]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[45], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[45]]) 
dev.off()

png(filename = paste0("output/", names(mod)[46], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[46]]) 
dev.off()

png(filename = paste0("output/", names(mod)[47], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[47]]) 
dev.off()

png(filename = paste0("output/", names(mod)[48], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[48]]) 
dev.off()

png(filename = paste0("output/", names(mod)[49], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[49]]) + scale_x_continuous(limits=c(0,0.3))
dev.off()

png(filename = paste0("output/", names(mod)[50], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[50]])
dev.off()

png(filename = paste0("output/", names(mod)[51], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[51]]) 
dev.off()

png(filename = paste0("output/", names(mod)[52], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[52]]) 
dev.off()

png(filename = paste0("output/", names(mod)[53], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[53]]) 
dev.off()

png(filename = paste0("output/", names(mod)[54], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[54]]) 
dev.off()

png(filename = paste0("output/", names(mod)[55], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[55]]) 
dev.off()

png(filename = paste0("output/", names(mod)[56], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[56]]) 
dev.off()

png(filename = paste0("output/", names(mod)[57], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[57]])  
dev.off()

png(filename = paste0("output/", names(mod)[58], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[58]])
dev.off()

png(filename = paste0("output/", names(mod)[59], "_three_conturies_worth_plot.png"), width = 30, height = 15, units = "cm", res = 400)
plot_worth(mod[[59]])
dev.off()
...
# save summary as txt files 
for (i in seq_along(mod)) {
  capture.output(summary(mod[[i]], ref = "Poli"), 
                 print(paste0(names(mod[i]), "all_three_PL_summary")),
                 coef(mod[[i]], ref = "Poli"),
                 file =paste0("output/",names(mod[i]), "all_three_PL_summary.txt"))}
# 
# 
# # 여기 다시 
# ### all Kendal tau 
...
### three_countriesKendal tau 
### recacluate ranking for kendall taue
# list of ground nut ranking
R_for_k <- vector(mode = "list", length = length(three_countries_traits_list))

for (i in seq_along(three_countries_traits_list)) {
  
  R_for_k[[i]] <-rank_tricot(data = three_df_excluded, 
                             items = variety,
                             input =c(unlist(three_countries_traits_list[i])),
                             validation.rankings = FALSE)}  # do not cosider evencase.
...
all_tree_countries_r <- r
all_tree_countries_p_value<- p_value


write.table(all_tree_countries_r,file="data/all_kendall_tau.csv",  append=FALSE, sep= "," , row.names = FALSE, col.names=TRUE)
write.table(all_tree_countries_p_value,file="data/all_kendall_tau_pvalue.csv",  append=FALSE, sep= "," , row.names = FALSE, col.names=TRUE)
